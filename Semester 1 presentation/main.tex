...
\begin{frame}{Tight binding model with spin orbit coupling}{Modelling NbSe$_2$}
  \begin{itemize}
    ...
    \item It uses the $d_{z^2}$, $d_{xy}$ and $d_{x^2-y^2}$ orbitals of Nb atoms up to third nearest neighbor sites as a basis set to describe the electronic states of the NbSe$_2$ monolayer.
...
\begin{frame}{TBM Nearest Neighbors (NN)}{Modelling NbSe$_2$}
  ...
  \begin{figure}
    ...
    \end{minipage}
    \captionof{figure}{FIG. 1. (a) and (b) from Habara et al$^{[3]}$ Displaying a top-down view and side view of the structure of monolayer NbSe$_2$ consisting of Nb (black) and Se(yellow) atoms. The first, second and third nearest neighbor sites are shown in green, red and blue respectively. $a$ is the lattice constant.}
  \end{figure}
...
\begin{frame}{Habara FIG 1. (d)}{Modelling NbSe$_2$}
  ...
  \end{minipage}
  \captionof{figure}{Habara et al$^{[1]}$ FIG. 1. (d), Energy band structure and DOS taken across slice $M \rightarrow K' \rightarrow \Gamma \rightarrow K \rightarrow M$. Note they have taken $K$ and $K'$ to have opposite meanings. Our recreation is shown on the right for comparison}
  \end{figure}
\end{frame}
...
\begin{frame}{Twisted triangles}{Adding a twist}
  \begin{figure}
  \centering
    \resizebox{8cm}{!}{\includegraphics{twisted_triangles.png}}
...
\begin{frame}{Two triangle path}{Adding a twist}
  \begin{figure}
  \centering
    \resizebox{8cm}{!}{\includegraphics{heterostructure_BZ_path.png}}
...
\begin{frame}{Twisted eigenvalues}{Adding a twist}
  \begin{figure}
  \centering
    \resizebox{8cm}{!}{\includegraphics{twisted_evalues_1.png}}
...
\begin{frame}{Un-twisted eigenvalues}{Adding a twist}
  \begin{figure}
  \centering
    \resizebox{8cm}{!}{\includegraphics{twisted_evalues_2.png}}
...
\begin{frame}{Varying the angle}{Constructing a heterostructure}
  \begin{itemize}
    \item GIF of eigenvalues at varying angles
    \item \hyperlink{file://./Animation.gif}
    \item Notice that the intersection of energy bands varies with angle as a consequence.
